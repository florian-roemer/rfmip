...
ws.abs_speciesSet(species=["H2O","H2O-SelfContCKDMT350"])
...
# ws.stokes_dim = 1
# ws.rtp_temperature = 300
# ws.rtp_pressure = 1e4
# ws.rtp_vmr = [0.01, 0.01]
# ws.rtp_mag = [0, 0, 0]
# ws.rtp_los = [0, 0]
...
def propmat_clearsky_agenda(ws):
    ...
    ws.propmat_clearskyAddScaledSpecies(target="H2O-SelfContCKDMT350", scale=0.1)
